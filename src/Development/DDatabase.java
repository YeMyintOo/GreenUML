...
public class DDatabase extends Rectangle{
	...
	public DDatabase(double x, double y, Color color) {
		super(x, y, 120, 60);
		//setTranslateZ(10);
		...
		dataV = new SimpleStringProperty("MySQL");
		data = new Text();
		...
		shape = new Rectangle(x + 10, y - 10,120,60);
