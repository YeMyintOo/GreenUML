...
public class ClassAbstract extends Rectangle {
	...
	public ClassAbstract(double x, double y, Color color) {
		super(x, y, 140, 40);
		setFill(color);
		...
		funBox.xProperty().bind(xProperty());
		funBox.yProperty().bind(yProperty().add(getHeight()));

		label = new Text(name.get());
		label.setFont(Font.font("Arial",FontWeight.BLACK, FontPosture.ITALIC, 15));
