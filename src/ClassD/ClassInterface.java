...
public class ClassInterface extends Rectangle {
	...
	public TextFlow head;
	public Text label;
	public TextField field;

	public CNode resizeB;

	public ClassInterface(double x, double y, Color color) {
		super(x, y, 150, 60);
		setFill(color);
		...
		Text h1 = new Text("<<");
		h1.setFill(Color.DARKRED);
		h1.setFont(Font.font("Arial", FontWeight.BLACK, 15));
		Text var = new Text("interface");
		var.setFont(Font.font("Arial", FontWeight.BLACK, 15));
		var.setFill(Color.GREENYELLOW);
		Text h2 = new Text(">>");
		h2.setFill(Color.DARKRED);
		h2.setFont(Font.font("Arial", FontWeight.BLACK, 15));
		head = new TextFlow(h1, var, h2);

		head.layoutXProperty().bind(xProperty().add(widthProperty().getValue() / 2).subtract(62));
		head.layoutYProperty().bind(yProperty().add(12));
