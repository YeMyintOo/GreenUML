...
public class DProtocal extends Line {
	...
	public DProtocal(double startx, double starty, double endx, double endy, Color color) {
		...
		node1 = new Rectangle();
		node2 = new Rectangle();
		startNode = new Rectangle();
		endNode = new Rectangle();
